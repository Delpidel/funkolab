<template>
    ...
    <div class="list-products">
      <v-card width="260px" class="pa-2 mb-6 ml-4 mr-4" v-for="product in produtosRestantes" :key="product.id">
        <v-img
          :src="product.imagem"
          class="align-end"
          width="300px"
        ...
        <v-card-actions>
          <v-btn color="green" @click="() => this.$store.dispatch('adicionarProduto', { product })">
            Comprar
          </v-btn>
        </v-card-actions>
      </v-card>
